...
module.exports = {
  ...
  resolve: {
    ...
    alias: {
      '@': ROOT_DIR,
      component: path.resolve(ROOT_DIR, './lib/component'),
      store: path.resolve(ROOT_DIR, './lib/store'),
      css: path.resolve(ROOT_DIR, './lib/assets/css'),
      util: path.resolve(ROOT_DIR, './lib/util'),
      config: path.resolve(ROOT_DIR, './config.js'),
      Loading: path.resolve(ROOT_DIR, './lib/component/common/Loading.js'),
      Action: path.resolve(ROOT_DIR, './lib/component/common/Action.js'),
      Axios: path.resolve(ROOT_DIR, './lib/util/axios.js'),
      MainHeader: path.resolve(ROOT_DIR, './lib/component/common/MainHeader.js'),
      Header: path.resolve(ROOT_DIR, './lib/component/common/Header.js'),
      Spin: path.resolve(ROOT_DIR, './lib/component/common/Spin.js'),
      AppState: path.resolve(ROOT_DIR, './lib/store/AppState.js'),
      Permission: path.resolve(ROOT_DIR, './lib/component/common/Permission.js'),
      Constants: path.resolve(ROOT_DIR, './lib/util/Constants.js'),
    },
  },
  module: {
    rules: [
  ...
  plugins: [
    ...
    new HtmlWebpackPlugin({
      ...
      template: path.resolve(ROOT_DIR, './lib/index.ejs'), // Load a custom template (ejs by default see the FAQ for details)
    }),
