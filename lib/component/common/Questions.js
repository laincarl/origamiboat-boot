...
(function () {
  ...
  reactHotLoader.register(Questions, 'Questions', 'src/component/common/Questions.js');
  reactHotLoader.register(_default, 'default', 'src/component/common/Questions.js');
  leaveModule(module);
})();
